...
export class DashboardComponent implements OnInit {
  ...
  cardLists = [
    ...
    , data: [
        ...
        , { uName: 'Nina Jones', message: 'Hey I\'ve attached some new PSD files for you to go over.', time: new Date(), icon: '/assets/images/icons/user1.png' }
    ...
    , data: [
        ...
        , { uName: 'James Smith', message: 'Good morning! You are fired!', time: new Date(), icon: '/assets/images/icons/user3.png' }
        , { uName: 'Nina Jones', message: 'Hello could you bring me cofee please?', time: new Date(), icon: '/assets/images/icons/user4.png' }
      ]
    }
  ];
